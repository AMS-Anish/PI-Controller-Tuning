...
correct_sheet_name = 'Data_with_5_Decimal_Points';  % Replace 'SheetName' with the actual sheet name

% Load data from Excel file
data = readtable('K:\Study\Master Thesis\Final Test\Probe_6_17-06-24\Probe_6_Report_2_Smooth.xlsx', 'Sheet', correct_sheet_name);
...
matlab2tikz('K:\Study\Master Thesis\Final Test\Probe_6_17-06-24\Tuned_Compressive2.tex');
