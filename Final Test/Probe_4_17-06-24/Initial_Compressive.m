...
data = readtable('K:\Study\Master Thesis\Final Test\Probe_4_17-06-24\Probe_Report.xlsx', 'Sheet', 'Probe_4_17-06-24');

% Extract the relevant columns
time = data.Time;
force_applied = data.Force_Applied_A;
force_measured = data.Force_Sensor_A;
...
matlab2tikz('K:\Study\Master Thesis\Final Test\Probe_4_17-06-24\Initial_Compressive.tex');
